...
static const MonoBundledAssembly assembly_bundle_mqoToEffekseerModelConverter_exe = {"mqoToEffekseerModelConverter.exe", assembly_data_mqoToEffekseerModelConverter_exe, 32256};
